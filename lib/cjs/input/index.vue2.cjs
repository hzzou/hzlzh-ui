...
const index = require("../icon/index.vue.cjs");
const _hoisted_1 = {
  key: 0,
  class: "input-prepend"
};
  ...
  setup(__props, { emit: emitEvent }) {
    ...
    return (_ctx, _cache) => {
      return vue.openBlock(), vue.createElementBlock("div", {
        ...
        wordVisible.value ? (vue.openBlock(), vue.createElementBlock("span", _hoisted_10, vue.toDisplayString(__props.modelValue.length + "/" + _ctx.$attrs.maxlength), 1)) : vue.createCommentVNode("", true)
      ], 2);
    };
  }
});
