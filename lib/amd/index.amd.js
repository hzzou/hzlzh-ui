define(["exports", "./button/index.vue.amd", "./input/index.vue.amd", "./dialog/index.vue.amd", "./popper/index.vue.amd", "./icon/index.vue.amd", "./virtualTable/index.vue.amd", "./VirtualSelect/index.vue.amd", "./layout/row/index.vue.amd", "./layout/row/index.vue.amd2", "./layout/col/index.vue.amd"], function(exports, index$2, index$3, index$4, index$5, index$6, index$7, index$8, index_vue_vue_type_script_lang, index_vue_vue_type_style_index_0_lang, index$1) {
  "use strict";
  const prefix = "hz-";
  const components = [
    ...
    { name: prefix + "virtual-select", value: index$8.default }
  ];
  const index = {
    install(app) {
      components.map((item) => {
  ...
  exports.VirtualSelect = index$8.default;
