define(["exports", "vue", "./renderTableHeader.amd", "./renderTBodyRow.amd"], function(exports, vue, renderTableHeader, renderTBodyRow) {
  "use strict";
  ...
  const _sfc_main = /* @__PURE__ */ vue.defineComponent({
    ...
    setup(__props, { emit: emitEvent }) {
      const props = __props;
      let scrollOffset = vue.ref(0), itemCount = vue.ref(0), headKey = vue.ref([]), itemData = vue.ref([]);
      vue.onBeforeMount(() => {
      ...
      return (_ctx, _cache) => {
        return vue.openBlock(), vue.createElementBlock("div", _hoisted_1, [
          vue.createElementVNode("article", {
            ...
            __props.showHeader ? (vue.openBlock(), vue.createBlock(vue.unref(renderTableHeader.default), vue.normalizeProps(vue.mergeProps({ key: 0 }, { headKey: vue.unref(headKey), itemHeight: __props.itemHeight, headerAlign: __props.headerAlign, fixHead: __props.fixHead })), null, 16)) : vue.createCommentVNode("", true),
            vue.createElementVNode("section", {
              ...
              vue.unref(itemData).length ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_2, [
                (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(vue.unref(itemData), (item) => {
                  return vue.openBlock(), vue.createBlock(vue.unref(renderTBodyRow.default), vue.normalizeProps(vue.mergeProps({
                    key: item.index
