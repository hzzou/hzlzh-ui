      ...
      return openBlock(), createElementBlock("div", {
        ...
        __props.type !== "textarea" ? (openBlock(), createElementBlock("section", {
          ...
          createElementVNode("section", {
            ...
            _ctx.$slots.suffix || __props.suffixIcon || showClear.value || __props.showPassword ? (openBlock(), createElementBlock("span", _hoisted_5, [
        ...
        wordVisible.value ? (openBlock(), createElementBlock("span", _hoisted_10, toDisplayString(__props.modelValue.length + "/" + _ctx.$attrs.maxlength), 1)) : createCommentVNode("", true)
      ], 2);
    };
  }
});
